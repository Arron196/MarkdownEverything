...
<p align="center">
  <strong>把网页、文档、文本、音频和视频转成干净、结构化、方便阅读、归档、搜索和 AI 使用的 Markdown。</strong>
</p>
...
MarkdownEverything 是一个开源的内容处理服务，负责将杂乱的原始素材转换成干净、可用的 Markdown。它会抓取内容、提取有用部分、保留源元数据、保存相关素材，并打包生成适合阅读、搜索、RAG、Agent 工作流、Obsidian 归档和未来 MCP 集成的结果。
...
| 视频文件 | 已支持 | ffmpeg 提取音频并生成 ASR 时间线 |
